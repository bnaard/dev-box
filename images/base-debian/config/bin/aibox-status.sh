...
print_status_json() {
  ...
  printf '{'
  printf '"memory_current":%s,' "$(json_string "$status_memory_current")"
  printf '"memory_max":%s,' "$(json_string "$status_memory_max")"
  printf '"oom_kill":%s,' "$(json_string "$status_oom_kill")"
