...
**Status:** pending
**aibox CLI:** v0.25.0 → v0.25.1
**processkit:** v0.25.8

## Summary

aibox has been updated from v0.25.0 to v0.25.1. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.25.0 and v0.25.1 is listed below.                  Review each; treat entries tagged as breaking as action items.
