...
**Status:** pending
**aibox CLI:** v0.23.17 → v0.23.18
**processkit:** v0.25.8

## Summary

aibox has been updated from v0.23.17 to v0.23.18. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.23.17 and v0.23.18 is listed below.                  Review each; treat entries tagged as breaking as action items.
