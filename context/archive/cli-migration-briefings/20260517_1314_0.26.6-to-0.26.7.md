...
**Status:** pending
**aibox CLI:** v0.26.6 → v0.26.7
**processkit:** v0.26.14

## Summary

aibox has been updated from v0.26.6 to v0.26.7. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.26.6 and v0.26.7 is listed below.                  Review each; treat entries tagged as breaking as action items.
