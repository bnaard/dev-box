...
**Status:** pending
**aibox CLI:** v0.32.6 → v0.33.1
**processkit:** v0.28.6

## Summary

aibox has been updated from v0.32.6 to v0.33.1. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.32.6 and v0.33.1 is listed below.                  Review each; treat entries tagged as breaking as action items.
