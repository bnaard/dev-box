...
**Status:** pending
**aibox CLI:** v0.31.0 → v0.31.1
**processkit:** v0.28.5

## Summary

aibox has been updated from v0.31.0 to v0.31.1. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.31.0 and v0.31.1 is listed below.                  Review each; treat entries tagged as breaking as action items.
