...
**Status:** pending
**aibox CLI:** v0.27.6 → v0.27.7
**processkit:** v0.27.1

## Summary

aibox has been updated from v0.27.6 to v0.27.7. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.27.6 and v0.27.7 is listed below.                  Review each; treat entries tagged as breaking as action items.
