...
PROJECT_LOCAL_MANAGED_BLOCKS = {
    # The wrapper commands are a project adapter: processkit owns the schema,
    # while the consuming repo owns the concrete command strings.
    "pk-commands",
}
