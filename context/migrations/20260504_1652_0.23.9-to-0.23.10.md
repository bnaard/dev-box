...
**Status:** pending
**aibox CLI:** v0.23.9 → v0.23.10
**processkit:** v0.25.7

## Summary

aibox has been updated from v0.23.9 to v0.23.10. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.23.9 and v0.23.10 is listed below.                  Review each; treat entries tagged as breaking as action items.
...
processkit is pinned to `v0.25.7` (source: `https://github.com/projectious-work/processkit.git`).
