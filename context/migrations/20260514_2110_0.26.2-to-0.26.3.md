...
**Status:** pending
**aibox CLI:** v0.26.2 → v0.26.3
**processkit:** v0.26.9

## Summary

aibox has been updated from v0.26.2 to v0.26.3. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.26.2 and v0.26.3 is listed below.                  Review each; treat entries tagged as breaking as action items.
