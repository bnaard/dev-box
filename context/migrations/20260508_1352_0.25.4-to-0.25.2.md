...
**Status:** pending
**aibox CLI:** v0.25.4 → v0.25.2
**processkit:** v0.25.8

## Summary

aibox has been updated from v0.25.4 to v0.25.2. Review each section below
...
processkit is pinned to `v0.25.8` (source: `https://github.com/projectious-work/processkit.git`).
