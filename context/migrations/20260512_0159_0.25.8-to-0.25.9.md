...
- [ ] Verify `/workspace/context/templates/processkit/v0.26.1/` snapshot directory exists
...
- [ ] Check `/workspace/context/migrations/pending/` for processkit content migration files:
      ...
      - **When reviewing template files like `AGENTS.md`:** do NOT diff the installed
        ...
        `diff context/templates/processkit/v0.26.1/AGENTS.md context/templates/processkit/v0.26.1/AGENTS.md`
...
processkit is tracking `version = "latest"` — installed: `v0.26.1` (upgraded from `v0.26.1` — aibox.toml now targets `vlatest`) (source: `https://github.com/projectious-work/processkit.git`).
...
- [ ] processkit version reference matches `aibox.lock` (`v0.26.1`)
