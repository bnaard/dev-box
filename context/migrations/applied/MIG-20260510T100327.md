...
spec:
  ...
  generated_at: 2026-05-10T10:03:27Z
  summary: 28 changed upstream, 0 conflicts, 48 new, 0 removed, 0 stale-removed (2 groups affected)
  affected_groups:
  - AGENTS
  - skills/processkit
  ...
  - timestamp: '2026-05-10T10:06:17.080406+00:00'
    ...
    note: Applied processkit v0.26.0 integration migration. 28 upstream skill changes
      (aggregate-mcp lazy-import, pk-doctor new check modules, compliance contract rewrite,
      task-router route_task field extensions, team-creator RoleSlot catalog cutover,
      team-manager RoleSlot resolver hook, skill-gate new hook scripts). 48 new files.
      RoleSlot schema added. No conflicts. AGENTS.md locally edited and unchanged upstream.
---
