...
- [ ] Check `/workspace/context/migrations/pending/` for processkit content migration files:
      ...
      - **When reviewing template files like `AGENTS.md`:** do NOT diff the installed
        ...
        `diff context/templates/processkit/v0.23.1/AGENTS.md context/templates/processkit/v0.24.0/AGENTS.md`
...
processkit is pinned to `v0.24.0` (upgraded from `v0.23.1` — aibox.toml now targets `v0.24.0`) (source: `https://github.com/projectious-work/processkit.git`).
