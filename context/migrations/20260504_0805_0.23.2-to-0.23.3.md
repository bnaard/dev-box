...
**Status:** completed (verified 2026-05-04: project has advanced to aibox 0.23.5 / processkit v0.25.4; `aibox apply --no-container -y` resolved latest to v0.23.5 and reported runtime-home and processkit cache in sync; migration-management has no pending or in-progress entries)
...
processkit is pinned to `v0.25.3` (source: `https://github.com/projectious-work/processkit.git`).
