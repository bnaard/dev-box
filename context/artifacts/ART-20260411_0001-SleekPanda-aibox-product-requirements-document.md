...
kind: Artifact
metadata:
  id: ART-20260411_0001-SleekPanda-aibox-product-requirements-document
...
- Cloud hosting — environments run locally (remote dev is a future goal, BACK-20260410_2238-ProudLily-remote-development-research-review).
...
- v1.0 feature completeness definition (BACK-20260410_2236-SoundRabbit-adapt-aibox-self-hosted, PROJ-001 scope).
- Preview companion MVP scope (BACK-20260410_2236-CoolBear-preview-companion-design-review, PROJ-004).
- Remote development first deliverable (BACK-20260410_2238-ProudLily-remote-development-research-review).
