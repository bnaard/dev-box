...
kind: WorkItem
metadata:
  id: BACK-20260410_2239-NobleSage-docusaurus-addon-improvements-remove
...
spec:
  ...
  type: task
  priority: low
  description: 'Review context/research/docusaurus-addon-improvements-2026-03.md. Discuss removing global install, null runtime approach, docs-starlight same fix. Old ID: BACK-103.'
