...
|---|---|---|
| **A — installer** | Installer substitutes at render time (`aibox`, `v0.25.2`). | If still literal, read `aibox.toml` or ask the owner. |
...
Configured providers: **codex**. Coordinate via the entity
...
<sub>Scaffolded by processkit `v0.25.2` on `2026-05-03`. Re-rendered on each installer sync.</sub>
