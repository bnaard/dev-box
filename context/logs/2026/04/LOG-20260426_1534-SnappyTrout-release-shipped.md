...
spec:
  ...
  summary: 'aibox v0.21.0 released: sync content-diff data-loss fix (closes aibox#57), same-version sync short-circuit (closes aibox#56), multi-harness slash-command scaffolding (Codex/Cursor/Gemini/OpenCode). 654 tests passing. Phase 1 (Linux binaries + GitHub release) complete; Phase 2 (macOS binaries + GHCR images) pending user macOS-host run.'
  details:
    version: v0.21.0
    tag: v0.21.0
