...
spec:
  ...
  summary: "aibox v0.21.2 Phase 1 shipped \u2014 processkit v0.23.1 integration. Linux binaries (aarch64 + x86_64) attached to GH release; docs deployed to gh-pages. 720 tests passing (654 unit + 50 e2e + 16 integration); clippy + cargo audit clean. Phase 2 (macOS binaries + GHCR images) pending user macOS-host run of `./scripts/maintain.sh release-host 0.21.2`."
