...
kind: Note
metadata:
  id: NOTE-20260411_0001-SleekFjord-cli-architecture-config-spec
...
unconditionally — required for processkit MCP servers (PEP 723 scripts). See DEC-20260410_2234-TallDawn-python3-uv-unconditionally-in.
